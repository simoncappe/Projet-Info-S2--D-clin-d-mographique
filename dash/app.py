...
shp_commune = shp_commune[['ID', 'NOM','INSEE_DEP', 'NOM_M', 'INSEE_COM', 'geometry']]
...
data = data[['CODGEO','NETNAT','NETMIG','NETMOB','geometry']]#data VARPOP + geometry


geojson_dict = data['geometry'].__geo_interface__#conversion des géométries en format geojson
